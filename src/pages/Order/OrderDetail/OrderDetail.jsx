...
export default function OrderDetail() {
    ...
    const { id } = useParams();
    const { order, statusOrder } = useSelector((state) => state.order);
        ...
        <>
            ...
            <div className="w-10/12 sm:w-11/12 xs:w-full mx-auto">
                ...
                <div className="cart-inner flex gap-10 md:flex-col justify-center">
                    <div
                        className="cart-list w-full border border-gray-300 p-5 rounded-md overflow-y-auto overflow-x-hidden max-h-[450px] xxs:px-2  [&::-webkit-scrollbar]:w-1 
                ...
                [&::-webkit-scrollbar-thumb]:bg-gray-500"
                    >
                        {loading ? (
                            ...
                            <div className="flex flex-col gap-5 pb-5 border-b border-gray-300 xs:gap-y-8 w-full ">
                                {statusOrder === "succeeded" &&
