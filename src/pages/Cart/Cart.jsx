...
export default function Cart() {
    ...
    return (
        <>
            <Helmet>
                <title>Mocmacshop - Shopping Cart</title>
            </Helmet>
            <section className="py-10 px-16 xl:px-10 xxs:px-5 ">
                ...
                <div className="flex items-center gap-x-3">
                    ...
                    <h4 className="text-sm">
                        ...
                        MocMac's Purchase Protection program for buyers, get a
                        full refund in the rare case your item doesn't arrive,
                ...
                <p className="text-xs font-medium">
                    <i className="text-xl fa-solid fa-leaf mr-2 "></i>MocMac
